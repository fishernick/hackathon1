...
def get_archive_links():
    ...
    cookies = headers = { "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.5999.115 Safari/537.36", "host": "dining.purdue.edu", "connection": "keep-alive", "accept": "application/json, text/javascript, */*; q=0.01", "accept-encoding": "gzip, deflate, br, zstd", "accept-language": "en-US,en;q=0.9", "origin": "https://dining.purdue.edu", "referer": "https://dining.purdue.edu/menus/", "sec-ch-ua": "\"Google Chrome\";v=\"140\", \"Chromium\";v=\"140\", \"Not=A?Brand\";v=\"24\"", "sec-ch-ua-mobile": "?0", "sec-ch-ua-platform": "\"Windows\"", "sec-fetch-dest": "empty", "sec-fetch-mode": "cors", "sec-fetch-site": "same-origin", "x-requested-with": "XMLHttpRequest", "content-type": "application/json;charset=UTF-8" }
    resp = requests.get(archive_url, cookies=cookies)
...
user_location = (40.4230, -86.9210) #campus center
        ...
        if not incidents:
            ...
            if not incidents_geo:
                ...
                if not nearby:
                    ...
                    map_viz.save("/Users/nick/Documents/hacky/public/crime_map.html")
